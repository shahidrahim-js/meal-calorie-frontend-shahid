...
export default function HomePage() {
  ...
  return (
    <>
    <div className="max-w-dvw mx-auto min-h-[80vh] relative">
      <div className="grid grid-flow-row sm:grid-flow-col grid-rows-1 md:grid-rows-1 sm:grid-cols-2 gap-8 py-6 sm:py-16">
        <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
          ...
          <Link href='/register' className="py-3 lg:py-3 px-12 lg:px-16 text-white font-semibold rounded-lg border 
          border-red-800 bg-red-800 transition-all outline-none undefined capitalize hover:bg-transparent 
          hover:text-red-800 hover:border-red-800 hover:shadow-red-900 cursor-pointer">Register</Link>
        </div>
        <div className="flex w-full">
          <div className="h-auto md:h-full md:w-full">
            ...
            background:none opacity:1 border:0 margin:0 padding:0">
              <Image src="/diet-plan-schedule.png"
                alt="Meal Calorie"
                width={400}
                height={400}
                priority
                className="h-auto w-3/4.5 object-cover rounded-2xl animate-spin animation-duration-[200s]" />
            </span>
          </div>
        </div>
      </div>
